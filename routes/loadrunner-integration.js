 ...
 */
function generateLoadRunnerScript(journeyConfig, testConfig, errorSimulationEnabled = false) {
 ...
 */
function generateCurlSimulation(journeyConfig, testConfig, testDir, errorSimulationEnabled = false) {
  const { journeyInterval, duration } = testConfig;
